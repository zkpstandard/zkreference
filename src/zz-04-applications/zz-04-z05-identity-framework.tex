...
\hline\rowcolor{colorRowHead} \setlinenumbermargin{.95em}\CIL\textbf{Instantiation Method} & \textbf{Proof Details} & \textbf{Privacy / Robustness} \rowend
%%%%%%%%%%%%
\hline
...
& \setlinenumbermargin{17.05em}\CIL
  \begin{itemize}
...
& \setlinenumbermargin{22.1em}\CIL
  \begin{itemize}
...
\hline\rowcolor{colorRowHead} \setlinenumbermargin{1.em}\CIL\textbf{Instantiation Method} & \textbf{Proof Details} & \textbf{Privacy / Robustness} \rowend
%%%%%%%%%%%%
\hline
...
& \setlinenumbermargin{18.3em}\CIL
  \begin{itemize}
...
& \begin{itemize}
  ...
  \end{itemize}
& \setlinenumbermargin{42.1em}\internallinenumbers
  \begin{itemize}
