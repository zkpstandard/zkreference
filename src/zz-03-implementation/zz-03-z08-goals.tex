...
\xetexfontscale{.99}{Many additional aspects of interoperability remain to be analyzed and supported by standards, to support additional ZK proof system backends as well as additional communication and reuse scenarios.}


\inpar{Additional forms of interoperability}
...
\inpar{Additional relation styles}
...
\inpar{Recursive composition}
The technique of recursive composition of proofs, and its abstraction as Proof-Carrying Data (PCD) 
\cite{2010:ICS:proof-carrying-data,2014:crypto:Scalable-ZK-via-Cycles-of-EC}, %[CT10][BCTV14]
