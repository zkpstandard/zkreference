...
We recommend that most runs are executed on a single-threaded machine, with parallelizability being an optional metric to measure. 
	The benchmarks should be\revblock[rev:sec-par-bench-refer-to-section]{\ref{it:explain-parameter-kappa}}
...
In all of the following, the primitive underlying\revblock[rev:comp-sec-par:120-to-128-b]{\ref{it:comp-sec-par:120-to-128}} the ZKP statement should be given at a level of 128 bits or higher and match the security of the NIZK proof system.
\begin{itemize}
