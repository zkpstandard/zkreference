\phantomsection\section*{\centering Intellectual property --- expectations on disclosure and licensing}\addcontentsline{toc}{section}{Intellectual Property}
\label{prelim:IP}
...
valuable to set expectations about the disclosure of intellectual property and the handling of patent claims.
	...
	\revblock[rev:intellectual-property:clarify-whose-claims-are-in-scope]{\ref{it:intellectual-property:minor-tweak}}
