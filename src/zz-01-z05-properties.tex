...
\textbf{To improve.}\revblock[rev:pok:suggest-ZKPoK-game]{\ref{it:pok:suggest-ZKPoK-game}}
...
\label{sec:security:defs-props:transferability-deniability}
	...
	\revblock[rev:introduce-deniability-transferability]{\ref{it:transferability-vs-interactivity-elaborate}}
