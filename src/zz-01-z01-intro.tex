...
\label{security:intro:what-is-a-ZK}
	...
	A zero-knowledge proof (ZKP)\revblock[rev:acronym-ZKP]{\ref{it:pok:describe}} makes it possible to prove a statement is true while preserving confidentiality of secret information.
