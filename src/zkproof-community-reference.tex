...
\newsetbool{boolShowFeedback}{true}
\ifbool{boolShowFeedback}{%
		%LB to-do: add header in cover page mentioning this is the ``trackchanges'' version
		}{\newcommandtwoopt{\revblock}[3][][]{}} % Use true to show the table of feedback comments
...
%\cleartooddpage\input{zz-B-proposals.tex}
