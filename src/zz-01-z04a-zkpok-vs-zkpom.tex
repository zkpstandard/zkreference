...
\revblock[rev:pok:ZKPoK-vs-ZKPoM]{\ref{it:pok:ZKPoK-vs-ZKPoM}}
...
\label{security:zkp-knowledge-vs-membership:ZKPoK-DL}
	...
	\revblock[rev:pok:example-ZKPoK-DL]{\ref{it:pok:example-ZKPoK-DL}}
...
\label{security:zkp-knowledge-vs-membership:ZKPoK-hash-pre-image}
	...
	\revblock[rev:pok:example-ZKPoK-pre-image]{\ref{it:pok:example-ZKPoK-pre-image}}
...
\label{security:zkp-knowledge-vs-membership:ZKPoM-GNI}
	...
	\revblock[rev:pok:example-ZKPoM-GNI]{\ref{it:pok:example-ZKPoM-GNI}}
...
Therefore, in this case the dual notion of a ZKP of knowledge does not apply.
	A classical example uses the language of pairs of non-isomorphic graphs,  %%% add reference here
