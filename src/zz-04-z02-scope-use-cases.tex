...
\paragraph{Verifiability type.}\revblock[rev:editorial:applications:verifiability-type]{\ref{it:editorial:applications-move-notation}}
...
\end{enumerate}
	...
	\refsec{section:transferability-deniability-interactivity} discusses transferability vs.\ deniability, %%%public verifiability vs. designated verifiability
\revblock[rev:apps:verifiability:new-content-preamble]{\ref{it:apps:verifiability:new-content-preamble}}
...
%%%\paragraph{Designated-verifier proofs.}
	...
	\revblock[rev:scope-use-cases-new-content]{\ref{it:scope-use-cases-new-content}}
