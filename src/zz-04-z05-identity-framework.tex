...
\newenvironment{funcprivtabular}[3]{\begin{center}\footnotesize\begin{edtable}{tabular}{%
		|>{\begminB{#1}}l<{\myendmini}|%
		>{\begminB{#2}}l<{\myendmini}|%
		%>{\begminB{#3}}l<{\myendmini}|%
		>{\begminB{#3}}l|}
...
\revblock[rev:editorial:tables-functionalities-portrait]{\ref{it:editorial:tables-functionalities-portrait}}
...
\revblock[rev:apps:identity-framework:move-paragraph-focus-accredited-investors]{\ref{it:apps:identity-framework:move-paragraph-focus-accredited-investors}}
