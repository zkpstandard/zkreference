...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\phantomsection\chapter{Acronyms and glossary} %VII
...
\item SNARK: Succinct Non-interactive ARgument of Knowledge. A special type of non-interactive proof system where the proof size is small and verification is fast.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section[Glossary 2]{Glossary 2\luis{Originally in the Implementations track}}

%The following extends the Security Track’s glossary.  %% LB: removed when merging the glossaries

%%%\subsection*{Glossary 2\luis{Originally in the Implementations track. Several of these definitions are given ipsis verbis elsewhere, e.g., in \refsec{security:terminology}. 
